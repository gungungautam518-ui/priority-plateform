          ...
          >
            ...
            {view !== 'forgot-password' ? (
              <>
                ...
                <div id="oauth_providers" className="mb-5">
                  <button
                    id="google_oauth_btn"
                    onClick={() => showToast('Redirecting securely to Google Identity Service...', 'info')}
                    className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl border border-zinc-800 bg-zinc-900/40 hover:bg-zinc-900 hover:border-indigo-500/50 text-sm font-medium text-zinc-300 hover:text-white transition-all active:scale-[0.98] duration-150 cursor-pointe"
                  >
